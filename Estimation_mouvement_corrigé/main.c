...
int main()
{
    ...
    //Echantillonnage
    //Echantillonnage echantillon = creation_remplissage_echantillon(mat1,dimX,dimY);
    ...
    //remplissage_fichier_double("Echantillon_1.txt",echantillon.dimX_Echantillon_1,echantillon.dimY_Echantillon_1,echantillon.mat_Echantillon_1);
    //remplissage_fichier_double("Echantillon_2.txt",echantillon.dimX_Echantillon_2,echantillon.dimY_Echantillon_2,echantillon.mat_Echantillon_2);
